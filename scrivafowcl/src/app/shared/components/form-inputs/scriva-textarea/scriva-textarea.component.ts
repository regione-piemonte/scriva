...
@Component({
  selector: 'scriva-textarea',
  templateUrl: './scriva-textarea.component.html',
  styleUrls: ['./scriva-textarea.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ScrivaTextareaComponent),
      multi: true,
    },
  ],
})
export class ScrivaTextareaComponent
