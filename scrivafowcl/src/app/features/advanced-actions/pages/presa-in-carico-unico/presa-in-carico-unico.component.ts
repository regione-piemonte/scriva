...
@Component({
  selector: 'app-presa-in-carico-unico-unico',
  templateUrl: './presa-in-carico-unico.component.html',
  styleUrls: ['./presa-in-carico-unico.component.scss'],
})
export class PresaInCaricoUnicoComponent
  ...
  implements OnInit
{
  ...
  chiave: AdvancedActionsChiavi = AdvancedActionsChiavi.PRENDI_IN_CARICO_SUAP;
  codMaschera: AdvancedActionsMaschere =
    AdvancedActionsMaschere.PRENDI_IN_CARICO_SUAP;
  componente: string;
  ...
  constructor(
    ...
    this.scrivaBreadCrumbItems = [
      ...
      {
        label: 'Prendi in carico da procedimento unico',
      },
    ];
  }
