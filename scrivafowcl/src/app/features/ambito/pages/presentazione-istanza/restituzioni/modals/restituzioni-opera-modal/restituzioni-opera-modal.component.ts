...
import { IFormIoRestituzioniOperaParams } from './utilities/restituzioni-opera-modal.interfaces';
...
export class RestituzioniOperaModalComponent
  ...
  implements OnInit
{
   ...
   * @returns IFormIoRestituzioniOperaParams con le informazioni da iniettare.
   * @override
   */
  protected initFormIoInjectParams(): IFormIoRestituzioniOperaParams {
    ...
    const formioCaptazioniOperaParams: IFormIoRestituzioniOperaParams = {
