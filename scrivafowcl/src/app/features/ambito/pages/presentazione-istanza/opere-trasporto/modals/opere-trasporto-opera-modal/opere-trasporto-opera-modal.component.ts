...
import { IFormIoOpereTrasportoOperaParams } from './utilities/opere-trasporto-opera-modal.interfaces';
...
export class OpereTrasportoOperaModalComponent
  ...
  implements OnInit
{
   ...
   * @returns IFormIoOpereTrasportoOperaParams con le informazioni da iniettare.
   * @override
   */
  protected initFormIoInjectParams(): IFormIoOpereTrasportoOperaParams {
    // Creo un oggetto con le informazioni extra da definire come render options
    const formioCaptazioniOperaParams: IFormIoOpereTrasportoOperaParams =
      {
