...
public class IndexIntegrationTst {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String filePath = "D:\\download.pdf";
        String uuidIndex = "1f7a0436-92e8-11eb-b6fc-33a38835d03a";
        uuidIndex = "9f2b11a3-80c3-11eb-bc68-2941b0514579";
        String token = getToken();
        System.out.println("\n\nTOKEN : \n\n" + token + "\n\n");

        //Creazione cartella
//        String foldername = "VIA_TEST";
//        uuidIndex = createContent(token, foldername);
...
//        }
        ...
        uuidIndex = "9f2b11a3-80c3-11eb-bc68-2941b0514579"; // folder root cm:scriva
        //token = "1bb2db57-794e-3846-975b-5629475b782d";

        System.out.println(createContent(token, uuidIndex, file, filePath));

        /* Recupero metadata file */

//        uuidIndex = "1b552159-976f-11eb-b6fc-33a38835d03a";
//        uuidIndex = "ccabe57a-b958-11eb-835d-2b2d2b646ad3";
...
//        retrieveContentData(token, uuidIndex);
    ...
    private static String getToken() throws IOException {
        String tokenUrl = "http://...../token";
        OauthHelperLocal oauthHelper = new OauthHelperLocal(
                tokenUrl,
                "ConsumerscrivabesrvIndexInt01Test",
                "ConsumerSecretExample1234567890",
                10000);
        return oauthHelper.getToken();
    }

    private static String getTokenFake() throws IOException {
        String tokenUrl = "http://....../token";
        OauthHelperLocal oauthHelper = new OauthHelperLocal(
                tokenUrl,
                "ConsumerscrivabesrvIndexInt01Test",
    ...
    private static String createContent(String accessToken, String folderName) {
        ...
        try {
            ...
            operationContext.setUsername("user");
            operationContext.setPassword("pwd");
            operationContext.setTenant("scriva");
            ...
            node.setModelPrefixedName("cm:scriva");
    ...
    private static String createContent(String accessToken, String parentNodeUid, File file, String filePath) {
        // url chiamata creazione contenuto su api manager tst-api-piemonte
        String url = "http://";
...
*/
            ...
            ObjectMapper objectMapper = new ObjectMapper()
                    ...
                    .configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false).findAndRegisterModules();
            String jsonNode = objectMapper.writeValueAsString(node);
            System.out.println("parentNodeUid : \n" + parentNodeUid);
            System.out.println("node : \n" + jsonNode);

            byte[] bytes = Files.readAllBytes(Paths.get(filePath));
            byte[] bytes2 = FileUtils.readFileToByteArray(file);
 ...
 */
                GenericType<IndexGenericResult> indexResultGenericType = new GenericType<>() {
                };
                IndexGenericResult indexGenericResult = resp.readEntity(indexResultGenericType);
                System.out.println("********************>>>> UID Nodo : " + indexGenericResult.getOutput());
                result = (String) indexGenericResult.getOutput();
    ...
    private static void retrieveContentData(String accessToken, String uuidIndex) {
        ...
        String url = "http://" + uuidIndex + "/contents?contentPropertyName=cm:content";
        System.out.println("\n\n" + url + "\n\n");
        try {
            String xRequestAuth = getXRequestAuth();
    ...
    private static void deleteContent(String accessToken, String uuidIndex) {
        ...
        try {
            IndexOperationContext operationContext = new IndexOperationContext();
            operationContext.setUsername("user_admin_da sostituire");
            operationContext.setPassword("pwd da sostituire");
            operationContext.setTenant("scriva");
            operationContext.setRepository("primary");
    ...
    private static void updateMetadata(String accessToken, String uuidIndex) {
        ...
        String url = "http://..../documentale/indexcsiexp-exp03/v1/tenants/scriva/nodes/" + uuidIndex;
        try {
            String xRequestAuth = getXRequestAuth();
    ...
    private static String getXRequestAuth() throws JsonProcessingException {
        IndexOperationContext operationContext = new IndexOperationContext();
        operationContext.setUsername("");
        operationContext.setPassword("");
        operationContext.setTenant("scriva");
        operationContext.setRepository("primary");
