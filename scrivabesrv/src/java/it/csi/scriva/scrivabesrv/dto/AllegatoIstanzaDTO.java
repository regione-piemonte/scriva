...
public class AllegatoIstanzaDTO extends BaseDTO implements Serializable {
    ...
    /**
     * Gets data invio esterno.
     *
     * @return the data invio esterno
     */
    ...
    /**
     * Sets data invio esterno.
     *
     * @param dataInvioEsterno the data invio esterno
     */
    ...
    public String toString() {
        return "AllegatoIstanzaDTO {\n" +
                ...
                ",\n         codStatoOsservazione:" + codStatoOsservazione +
                super.toString() +
                "}\n";
    }
