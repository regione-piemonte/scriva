...
public class IstanzaExtendedDTO extends IstanzaDTO implements Serializable {
   ...
   *
   * @return the istanza responsabile array
   */
   ...
   *
   * @param the istanza responsabile array
   */
	public void setIstanzaResponsabile(List<IstanzaResponsabileExtendedDTO> istanzaResponsabile) {
