...
public class TipoNatura2000DTO extends BaseDTO implements Serializable {
    ...
    public String toString() {
        return "TipoNatura2000DTO {\n" +
                ...
                ",\n         codTipoNatura2000:'" + codTipoNatura2000 + "'" +
                ",\n         desTipoNatura2000:'" + desTipoNatura2000 + "'" +
                "}\n";
    }
