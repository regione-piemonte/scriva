...
public class OggettoIstanzaUbicazioneExtendedDTO extends OggettoIstanzaDTO implements Serializable {
    ...
    public OggettoIstanzaDTO getDTO() {
        ...
        dto.setFlgGeoModificato(this.getFlgGeoModificato());
        dto.setIndLivello(this.getIndLivello());
        return dto;
    }

    /**
     * Gets ubicazione oggetto istanza dto.
     *
     * @return List<UbicazioneOggettoIstanzaDTO>    ubicazione oggetto istanza dto
     */
    @JsonIgnore
    public List<UbicazioneOggettoIstanzaDTO> getUbicazioneOggettoIstanzaDTO() {
        List<UbicazioneOggettoIstanzaDTO> ubicazioneOggettoIstanzaDTOList = new ArrayList<>();
        List<UbicazioneOggettoIstanzaExtendedDTO> ubicazioneOggettoIstanzaExtendedDTOList = this.getUbicazioneOggettoIstanza();
        if (!ubicazioneOggettoIstanzaExtendedDTOList.isEmpty()) {
            for (UbicazioneOggettoIstanzaExtendedDTO ubicazioneOggettoIstanzaExtendedDTO : ubicazioneOggettoIstanzaExtendedDTOList) {
                UbicazioneOggettoIstanzaDTO ubicazioneOggettoIstanzaDTO = new UbicazioneOggettoIstanzaDTO();
                ubicazioneOggettoIstanzaDTO.setIdUbicazioneOggettoIstanza(ubicazioneOggettoIstanzaExtendedDTO.getIdUbicazioneOggettoIstanza());
                ubicazioneOggettoIstanzaDTO.setIdOggettoIstanza(ubicazioneOggettoIstanzaExtendedDTO.getIdOggettoIstanza());
                if (null != ubicazioneOggettoIstanzaExtendedDTO.getComune()) {
                    ubicazioneOggettoIstanzaDTO.setIdComune(ubicazioneOggettoIstanzaExtendedDTO.getComune().getIdComune());
                }
                ubicazioneOggettoIstanzaDTO.setDenIndirizzo(ubicazioneOggettoIstanzaExtendedDTO.getDenIndirizzo());
                ubicazioneOggettoIstanzaDTO.setNumCivico(ubicazioneOggettoIstanzaExtendedDTO.getNumCivico());
                ubicazioneOggettoIstanzaDTO.setDesLocalita(ubicazioneOggettoIstanzaExtendedDTO.getDesLocalita());
                ubicazioneOggettoIstanzaDTO.setIndGeoProvenienza(ubicazioneOggettoIstanzaExtendedDTO.getIndGeoProvenienza());
                ubicazioneOggettoIstanzaDTO.setGestAttoreIns(ubicazioneOggettoIstanzaExtendedDTO.getGestAttoreIns());
                ubicazioneOggettoIstanzaDTO.setGestAttoreUpd(ubicazioneOggettoIstanzaExtendedDTO.getGestAttoreUpd());
                ubicazioneOggettoIstanzaDTO.setGestDataIns(ubicazioneOggettoIstanzaExtendedDTO.getGestDataIns());
                ubicazioneOggettoIstanzaDTO.setGestDataUpd(ubicazioneOggettoIstanzaExtendedDTO.getGestDataUpd());
                ubicazioneOggettoIstanzaDTO.setGestUID(ubicazioneOggettoIstanzaExtendedDTO.getGestUID());
                ubicazioneOggettoIstanzaDTOList.add(ubicazioneOggettoIstanzaDTO);
            }
        }
        return ubicazioneOggettoIstanzaDTOList;
    }
}