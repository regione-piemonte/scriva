...
public class IstanzaCompetenzaDTO extends BaseDTO implements Serializable {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), idIstanza, idCompetenzaTerritorio, dataInizioValidita, dataFineValidita, flgAutoritaPrincipale, flgAutoritaAssegnataBO, indAssegnataDaSistema);
    }
