...
public class IstanzaResponsabileExtendedDTO extends IstanzaResponsabileDTO implements Serializable {
	 ...
	 */
	@JsonIgnore
	public IstanzaResponsabileDTO getDTO() {
        IstanzaResponsabileDTO dto = new IstanzaResponsabileDTO();
        dto.setIdIstanzaResponsabile(this.getIdIstanzaResponsabile());
        dto.setIdIstanza(this.getIdIstanza());
        if (this.getTipoResponsabile() != null) {
            dto.setIdTipoResponsabile(this.getTipoResponsabile().getIdTipoResponsabile());
        }
        dto.setLabelResponsabile(this.getLabelResponsabile());
        dto.setNominativoResponsabile(this.getNominativoResponsabile());
        dto.setRecapitoResponsabile(this.getRecapitoResponsabile());
