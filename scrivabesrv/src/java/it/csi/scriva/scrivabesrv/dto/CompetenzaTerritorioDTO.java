...
public class CompetenzaTerritorioDTO extends BaseDTO implements Serializable {
    ...
    @JsonIgnore
    private String numDimensionePec;
    ...
    /**
     * Gets num dimensione pec.
     *
     * @return the num dimensione pec
     */
    public String getNumDimensionePec() {
        return numDimensionePec;
    }

    /**
     * Sets num dimensione pec.
     *
     * @param numDimensionePec the num dimensione pec
     */
    public void setNumDimensionePec(String numDimensionePec) {
        this.numDimensionePec = numDimensionePec;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), idCompetenzaTerritorio, idTipoCompetenza, idEnteCreditore, idComuneCompetenza, codCompetenzaTerritorio, desCompetenzaTerritorio, desCompetenzaTerritorioEstesa, codSuap, indirizzoCompetenza, numCivicoIndirizzo, capCompetenza, desEmailPec, desEmail, orario, sitoWeb, dataInizioValidita, dataFineValidita, indVisibile, codIpa, numCellulare, desServizioApplicativo, numDimensionePec);
    }
    ...
    public String toString() {
        return "CompetenzaTerritorioDTO {\n" +
                ...
                ",\n         numDimensionePec:'" + numDimensionePec + "'" +
