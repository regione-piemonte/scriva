...
public class SearchDTO implements Serializable {
    ...
    @JsonProperty("ogg_app")
    private Boolean extractOggApp;
    ...
    /**
     * Gets extract ogg app.
     *
     * @return the extract ogg app
     */
    public Boolean getExtractOggApp() {
        return extractOggApp;
    }

    /**
     * Sets extract ogg app.
     *
     * @param extractOggApp the extract ogg app
     */
    public void setExtractOggApp(Boolean extractOggApp) {
        this.extractOggApp = extractOggApp;
    }
    ...
    public String toString() {
        return "SearchDTO {\n" +
                ...
                ",\n         cfCompilante:'" + cfCompilante + "'" +
                ",\n         cfFunzionario:'" + cfFunzionario + "'" +
                ",\n         cfSoggetto:'" + cfSoggetto + "'" +
                ",\n         statoIstanza:'" + statoIstanza + "'" +
                ",\n         simpleSearchMultipleFields:'" + simpleSearchMultipleFields + "'" +
                ",\n         tipoAdempimento:'" + tipoAdempimento + "'" +
                ",\n         adempimento:'" + adempimento + "'" +
                ",\n         dataInserimentoFrom:" + dataInserimentoFrom +
                ",\n         dataInserimentTo:" + dataInserimentTo +
                ",\n         dataPresentazioneFrom:" + dataPresentazioneFrom +
                ",\n         dataPresentazionTo:" + dataPresentazionTo +
                ",\n         provinciaOggettoIstanza:'" + provinciaOggettoIstanza + "'" +
                ",\n         comuneOggettoIstanza:'" + comuneOggettoIstanza + "'" +
                ",\n         idTipoEvento:" + idTipoEvento +
                ",\n         dataEventoFrom:" + dataEventoFrom +
                ",\n         dataEventoTo:" + dataEventoTo +
                ",\n         desStatoSintesiPagamento:'" + desStatoSintesiPagamento + "'" +
                ",\n         tipoPratiche:'" + tipoPratiche + "'" +
                ",\n         extractOggApp:" + extractOggApp +
