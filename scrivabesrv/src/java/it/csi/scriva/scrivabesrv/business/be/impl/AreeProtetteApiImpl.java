...
import it.csi.scriva.scrivabesrv.business.be.AreeProtetteApi;
...
public class AreeProtetteApiImpl extends BaseApiServiceImpl implements AreeProtetteApi {
     ...
     */
    @Override
    public Response getAreeProtette(Long idOggettoIstanza, String codIstatComuni, Boolean checkComuni,
        ...
        if (idOggettoIstanza != null) {
            return getResponseList(parchiService.getAreeProtette(idOggettoIstanza, checkComuni), className);
        }
        if (StringUtils.isNotBlank(codIstatComuni)) {
            return getResponseList(parchiService.getAreeProtetteByCodIstatComuni(codIstatComuni), className);
        }
        return getResponseList(parchiService.getAreeProtette(), className);
    }
}