 ...
 * @author CSI PIEMONTE
 */
public class LineStringGeometry extends Geometry implements Serializable{
    private static final long serialVersionUID = 8961512842696539564L;
    private List<List<BigDecimal>> coordinates;

    /**
     * Instantiates a new Line string geometry.
     */
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        LineStringGeometry that = (LineStringGeometry) o;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("LineStringGeometry {");
