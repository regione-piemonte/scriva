...
public interface CategorieOggettoApi {
     ...
     */
    @GET
    Response loadCategorieProgettuali(@HeaderParam("X-Request-Auth") String xRequestAuth, @HeaderParam("X-Request-Id") String xRequestId,
                                      @QueryParam("id_adempimento") Long idAdempimento, @QueryParam("id_istanza") Long idIstanza, @QueryParam("id_oggetto_istanza") Long idOggettoIstanza,
                                      @DefaultValue("") @QueryParam(value = "search") String search, @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);

    /**
     * Load categoria progettuale by id adempimento response.
     *
    ...
    Response loadCategoriaProgettualeByIdAdempimento(@PathParam("idAdempimento") Long idAdempimento, @DefaultValue("") @QueryParam(value = "search") String search, @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);

    /**
     * Load categoria progettuale by id oggetto istanza response.
     *
    ...
    Response loadCategoriaProgettualeByIdOggettoIstanza(@PathParam("idOggettoIstanza") Long idOggettoIstanza, @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
