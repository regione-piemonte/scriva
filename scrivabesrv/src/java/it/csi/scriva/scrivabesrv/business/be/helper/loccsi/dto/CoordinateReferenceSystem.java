...
public class CoordinateReferenceSystem {
  ...
  public CoordinateReferenceSystem coordinateSystem(CoordinateSystem coordinateSystem) {
  ...
  **/
  ...
  public CoordinateReferenceSystem domainOfValidity(Extent domainOfValidity) {
  ...
  **/
  ...
  public CoordinateReferenceSystem scope(InternationalString scope) {
    this.scope = scope;
    return this;
  }
  ...
  **/
  ...
  public CoordinateReferenceSystem alias(List<GenericName> alias) {
    this.alias = alias;
    return this;
  }

  public CoordinateReferenceSystem addAliasItem(GenericName aliasItem) {
    if (this.alias == null) {
  ...
  **/
  ...
  public CoordinateReferenceSystem remarks(InternationalString remarks) {
  ...
  **/
  ...
  public CoordinateReferenceSystem identifiers(List<ReferenceIdentifier> identifiers) {
    this.identifiers = identifiers;
    return this;
  }

  public CoordinateReferenceSystem addIdentifiersItem(ReferenceIdentifier identifiersItem) {
  ...
  **/
  ...
  public CoordinateReferenceSystem name(ReferenceIdentifier name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.coordinateSystem, coordinateReferenceSystem.coordinateSystem) &&
        Objects.equals(this.domainOfValidity, coordinateReferenceSystem.domainOfValidity) &&
        Objects.equals(this.scope, coordinateReferenceSystem.scope) &&
        Objects.equals(this.alias, coordinateReferenceSystem.alias) &&
        Objects.equals(this.remarks, coordinateReferenceSystem.remarks) &&
        Objects.equals(this.identifiers, coordinateReferenceSystem.identifiers) &&
        Objects.equals(this.name, coordinateReferenceSystem.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(coordinateSystem, domainOfValidity, scope, alias, remarks, identifiers, name);
  }
