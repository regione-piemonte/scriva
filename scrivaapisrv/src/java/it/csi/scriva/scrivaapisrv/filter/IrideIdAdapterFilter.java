 ...
 * =========================LICENSE_END==================================
 */
package it.csi.scriva.scrivaapisrv.filter;

import it.csi.iride2.policy.entity.Identita;
import it.csi.iride2.policy.exceptions.MalformedIdTokenException;
import it.csi.scriva.scrivaapisrv.business.*;
import it.csi.scriva.scrivaapisrv.util.*;
        ...
        if (hreq.getSession().getAttribute(IRIDE_ID_SESSIONATTR) == null) {
            ...
            if (marker != null) {
                try {
                    ...
                    it.csi.scriva.scrivaapisrv.dto.UserInfo userInfo = new it.csi.scriva.scrivaapisrv.dto.UserInfo();
