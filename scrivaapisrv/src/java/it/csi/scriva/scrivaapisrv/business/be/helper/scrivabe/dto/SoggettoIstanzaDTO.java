...
public class SoggettoIstanzaDTO extends BaseDTO implements Serializable {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("SoggettoIstanzaDTO {\n");
        ...
        sb.append(",\n         idRuoloCompilante:").append(idRuoloCompilante);
        ...
        sb.append(",\n         partitaIvaSoggetto:'").append(partitaIvaSoggetto).append("'");
        ...
        sb.append(",\n         statoEsteroNascita:'").append(statoEsteroNascita).append("'");
        ...
        sb.append(",\n         capNascita:'").append(capNascita).append("'");
