...
public interface SoggettiIstanzaApi {
     ...
     */
    @GET
    public Response getSoggettiIstanza(@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    public Response getSoggettoIstanza(@PathParam("idSoggettoIstanza") Long idSoggettoIstanza, @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    public Response getSoggettoIstanzaByIdSoggettoPadre(@PathParam("idSoggettoPadre") Long idSoggettoPadre, @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    public Response getSoggettiIstanzaByCodiceFiscaleSoggetto(@PathParam("codiceFiscale") String codiceFiscale, @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    public Response saveSoggettoIstanza(@RequestBody SoggettoIstanzaExtendedDTO soggettoIstanza, @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    @PUT
    @Consumes(MediaType.APPLICATION_JSON)
    public Response updateSoggettoIstanza(@RequestBody SoggettoIstanzaExtendedDTO soggettoIstanza, @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    @DELETE
    @Path("/{uid}")
    public Response deleteSoggettoIstanza(@PathParam("uid") String uid, @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    @DELETE
    @Path("/id/{id}")
    public Response deleteSoggettoIstanzaById(@PathParam("id") Long id, @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    @Path("/recapiti-alternativi")
    @Consumes(MediaType.APPLICATION_JSON)
    Response updateRecapitoAlternativo(@RequestBody it.csi.scriva.scrivaapisrv.business.be.helper.scrivabe.dto.RecapitoAlternativoExtendedDTO recapitoAlternativo, @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
