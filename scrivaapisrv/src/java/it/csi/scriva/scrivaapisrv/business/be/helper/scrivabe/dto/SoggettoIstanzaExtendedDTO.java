...
public class SoggettoIstanzaExtendedDTO extends SoggettoIstanzaDTO implements Serializable {
     ...
     * Gets dto.
     *
     * @return SoggettoIstanzaDTO dto
     */
    @JsonIgnore
    public SoggettoIstanzaDTO getDTO() {
        SoggettoIstanzaDTO dto = new SoggettoIstanzaDTO();
        dto.setIdSoggettoIstanza(this.getIdSoggettoIstanza());
        dto.setIdSoggettoPadre(this.getIdSoggettoPadre());

        if (null != this.getSoggetto()) {
            dto.setIdSoggetto(this.getSoggetto().getIdSoggetto());
        }
        if (null != this.getTipoSoggetto()) {
            dto.setIdTipoSoggetto(this.getTipoSoggetto().getIdTipoSoggetto());
        }
        if (null != this.getRuoloSoggetto()) {
        ...
        dto.setPartitaIvaSoggetto(this.getPartitaIvaSoggetto());
        ...
        dto.setStatoEsteroNascita(this.getStatoEsteroNascita());
        ...
        dto.setCapNascita(this.getCapNascita());
