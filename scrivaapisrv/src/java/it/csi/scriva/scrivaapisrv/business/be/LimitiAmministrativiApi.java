...
public interface LimitiAmministrativiApi {
    ...
    @GET
    @Path("/nazioni/attive")
    Response getNazioniAttive(@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    @GET
    @Path("/regioni/attive")
    Response getRegioniAttive(@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    Response getProvinceAttive(@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    @GET
    @Path("/comuni")
    Response getComuni(@QueryParam("cod_istat") String codIstat, @QueryParam("cod_istat_provincia") String codIstatProvincia,
                       @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    @GET
    @Path("/comuni/attivi")
    Response getComuniAttivi(@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
