...
public interface CategorieOggettoApi {
     ...
     */
    @GET
    Response getCategorieProgettuali(@HeaderParam("X-Request-Auth") String xRequestAuth, @HeaderParam("X-Request-Id") String xRequestId,
                                     ...
                                     @DefaultValue("") @QueryParam(value = "search") String search, @Context SecurityContext securityContext,
                                     @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest, @Context UriInfo uriInfo);
