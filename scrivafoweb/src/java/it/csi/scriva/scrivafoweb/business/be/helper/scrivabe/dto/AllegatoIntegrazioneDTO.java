...
public class AllegatoIntegrazioneDTO extends BaseDTO implements Serializable {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), idIntegraIstanzaAllegato, idIntegrazioneIstanza, idAllegatoIstanza, flgAllegatoRifProtocollo, nomeAllegato, codAllegato, uuidIndex);
    }
