...
import it.csi.scriva.scrivafoweb.business.be.ConfiguraRuoliSoggettiApi;
import it.csi.scriva.scrivafoweb.business.be.exception.GenericException;
import it.csi.scriva.scrivafoweb.business.be.helper.scrivabe.ConfiguraRuoliSoggettiApiServiceHelper;
...
/**
 * The type Configura ruoli soggetti api service.
 */
@Component
public class ConfiguraRuoliSoggettiApiServiceImpl extends AbstractApiServiceImpl implements ConfiguraRuoliSoggettiApi {
    ...
    public Response getConfiguraRuoliSoggetti(SecurityContext securityContext, HttpHeaders httpHeaders, HttpServletRequest httpRequest) {
        logBegin(className);
        List<ConfiguraRuoloSoggettoExtendedDTO> list = new ArrayList<>();
        try {
