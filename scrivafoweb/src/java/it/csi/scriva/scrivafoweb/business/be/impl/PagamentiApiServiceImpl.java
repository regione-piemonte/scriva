...
import it.csi.scriva.scrivafoweb.business.be.PagamentiApi;
import it.csi.scriva.scrivafoweb.business.be.exception.GenericException;
import it.csi.scriva.scrivafoweb.business.be.helper.scrivabe.PagamentiApiServiceHelper;
 ...
 */
@Component
public class PagamentiApiServiceImpl  extends ProxyApiServiceImpl implements PagamentiApi {
     ...
     */
    @Override
    public Response getPagamentiIstanza(Long idIstanza, SecurityContext securityContext, HttpHeaders httpHeaders, HttpServletRequest httpRequest, UriInfo uriInfo) {
