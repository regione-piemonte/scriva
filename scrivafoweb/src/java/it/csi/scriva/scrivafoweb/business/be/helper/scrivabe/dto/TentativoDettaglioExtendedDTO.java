...
public class TentativoDettaglioExtendedDTO extends TentativoDettaglioDTO implements Serializable {
    ...
    public TentativoDettaglioDTO getDTO() {
        ...
        if (this.getPagamentoIstanza() != null) {
            this.setIdPagamentoIstanza(this.getPagamentoIstanza().getIdPagamentoIstanza());
        }

        if (this.getTentativoPagamento() != null) {
            this.setIdTentativoPagamento(this.getTentativoPagamento().getIdTentativoPagamento());
        }

        this.setIuvTentativoPagamento(this.getIuvTentativoPagamento());
