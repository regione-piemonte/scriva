...
import it.csi.scriva.scrivafoweb.business.be.EnvironmentApi;
import it.csi.scriva.scrivafoweb.dto.Property;
...
public class EnvironmentApiServiceImpl implements EnvironmentApi {
    ...
    @Override
    public Response getEnvironment(SecurityContext securityContext, HttpHeaders httpHeaders, HttpServletRequest httpRequest) {
