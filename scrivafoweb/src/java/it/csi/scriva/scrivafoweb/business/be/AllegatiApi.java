...
public interface AllegatiApi {
    ...
    Response getFileAllegati(@HeaderParam("X-Request-Auth") String xRequestAuth, @HeaderParam("X-Request-Id") String xRequestId,
                             @QueryParam("id_istanza") Long idIstanza, @QueryParam("cod_allegato") String codAllegato, @QueryParam("output_format") String outputFormat,
                             @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    @Path("/_download")
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_OCTET_STREAM})
    Response getFileAllegatiSelezionati(
    ...
    Response getCategoriaAllegatoMandatoryByIdIstanza(@QueryParam("id_istanza") Long idIstanza, @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    Response checkAllegatoMandatoryDelegaFirmataByIdIstanza(@QueryParam("id_istanza") Long idIstanza, @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    Response getCategoriaAllegatoMandatoryAdempimentoByIdIstanza(@QueryParam("id_istanza") Long idIstanza, @Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
    ...
    @POST
    @Path("/_search")
    Response searchAllegati(@RequestBody Map<String, Object> requestBody,
                            @DefaultValue("1") @QueryParam(value = "offset") Integer offset,
                            @DefaultValue("20") @QueryParam(value = "limit") Integer limit,
                            @DefaultValue("") @QueryParam(value = "sort") String sort,
