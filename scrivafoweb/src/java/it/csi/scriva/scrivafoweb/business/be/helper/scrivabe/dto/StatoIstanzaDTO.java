...
public class StatoIstanzaDTO implements Serializable {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(idStatoIstanza, codiceStatoIstanza, descrizioneStatoIstanza, flgStoricoIstanza, indVisibile, desEstesaStatoIstanza, labelStato, pswRuolo);
    }
